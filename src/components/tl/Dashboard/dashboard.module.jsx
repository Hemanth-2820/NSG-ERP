              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px' }}>
                {announcements.slice(0, 3).map(ann => (
                  <div key={ann.id} style={{
                    ...
                    <div dangerouslySetInnerHTML={{ __html: ann.body }} style={{ fontSize: '13px', color: '#475569', margin: 0, lineHeight: 1.5, maxHeight: '120px', overflowY: 'auto', paddingRight: '4px' }} className={styles.announcementBodyScroll} />
                  </div>
                ))}
              </div>
            ) : (
