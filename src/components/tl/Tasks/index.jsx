    ...
    <div className={styles.container}>
      ...
      <div className={styles.viewContainer}>
        ...
        {viewModalOpen && viewTaskData && (
          <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }} onClick={(e) => { if(e.target === e.currentTarget) setViewModalOpen(false); }}>
